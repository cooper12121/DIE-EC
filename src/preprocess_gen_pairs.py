...
Options:
    ...
    --dataset=<dataset>   wec/ecb/zh - which dataset to generate for [default: wec]
...
def generate_pairs():
    ...
    positive_file = dirname + "/pair/" + basename + f"_PosPairs_{_ratio}.pickle" 
    negative_file = dirname + "/pair/" + basename + f"_NegPairs_{_ratio}.pickle"
...
if __name__ == '__main__':
    ...
    train_argv = ['../datasets/CDEC-zh/final_processed/train_event.json','--dataset','zh','--split','train','--ratio',10]
    dev_argv = ['../datasets/CDEC-zh/final_processed/dev_event_validated.json','--dataset','zh','--split','dev']
    test_argv = ['../datasets/CDEC-zh/final_processed/test_event_validated.json','--dataset','zh','--split','test']
