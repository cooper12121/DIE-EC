...
class MentionData(MentionDataLight):
    def __init__(self, mention_id, topic_id: str, doc_id: str, sent_id: int, tokens_numbers: List[int],
                 ...
                 mention_head_lemma: str, coref_chain: str, arguments:list,mention_type: str = 'NA', coref_link: str = "NA",
                 predicted_coref_chain: str = None, mention_pos: str = None,
                 mention_ner: str = None, mention_index: int = -1, gen_lemma: bool = False,edu_list=None,graph_info_list=None,mention_node_index=None) -> None:
        """
    ...
    def read_json_mention_data_line(mention_line):
        ...
        try:
            ...
            arguments=None
            edu_list = None
            graph_info_list=None
            metion_node_index =None
            ...
            if 'arguments' in mention_line:
                arguments=mention_line['arguments']
            
            if 'edu_list'in mention_line:
                edu_list = mention_line['edu_list']
            if 'graph_info_list' in mention_line:
                graph_info_list = mention_line['graph_info_list']
            if 'mention_node_index' in mention_line:
                mention_node_index=mention_line['mention_node_index']
            ...
            mention_data = MentionData(mention_id,
                                       ...
                                       mention_node_index=mention_node_index)
        except Exception:
