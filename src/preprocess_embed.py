...
Options:
    ...
    --max=<x>   Maximum surrounding context [default: 240]
...
if __name__ == '__main__':
    ...
    # argv = ['../datasets/CDEC-zh/final_processed/train_event.json','../datasets/CDEC-zh/final_processed/test_event_validated.json','../datasets/CDEC-zh/final_processed/dev_event_validated.json','--cuda',True]
    argv=['../datasets/CDEC-zh/final_processed/train_event.json','--cuda',True]
