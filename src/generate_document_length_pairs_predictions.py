...
if __name__ == '__main__':
    ...
    argv=['--tf','../experiments/document_length/document_length_0_512.pickle',
    ...
    log_params_str = dt_string+"_ds_" + "wec-eng" + "document_length"
    ...
    files = ['../experiments/document_length/document_length_0_512.pickle','../experiments/document_length/document_length_512_1024.pickle','../experiments/document_length/document_length_1024_upper.pickle']
    for file in files:
        filename = file.split("/")[-1]
        logger.info(f"experiment of document length on {filename}")
