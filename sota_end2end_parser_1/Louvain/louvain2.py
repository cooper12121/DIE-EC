...
def test():
    # import torch
    #
    # a_matrix=torch.rand((5,5))
    # print(a_matrix)
    # print(a_matrix.shape)
    a_matrix = pickle.load(open('./pair_pred_model.pickle','rb'))
    print(type(a_matrix))
    # matrix = a_matrix.numpy().tolist()
    # louvain = PyLouvain.from_matrix(matrix)
    # actual_partition, best_q=louvain.apply_method()
    # print(actual_partition,best_q)
