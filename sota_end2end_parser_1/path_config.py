...
# VOC
REL_raw2coarse = "data/voc/raw2coarse.pkl"   #这是什么文件
...
# SEGMENTATION
RAW_TRAIN_FILES = "data/seg/rst/TRAINING"
RAW_TEST_FILES = "data/seg/rst/TEST"
DATA_SETS = "data/seg/datasets.pkl"
DATA_SETS_SYN = "data/seg/datasets_all_syn.pkl"
DATA_SETS_RAW = "data/seg/datasets_raw.pkl"
WORD2IDS = "data/seg/voc/word2ids.pkl"
IDS2VEC = "data/seg/voc/ids2vec.pkl"
POS2IDS = "data/seg/voc/pos2ids.pkl"
SYN2IDS = "data/seg/voc/sync2ids.pkl"
GLOVE200 = "data/seg/voc/glove300d.txt"
LOG_ALL_SEG = "data/seg/log_all"
MODEL_SAVE_SEG = "data/seg/models_saved"

NMT_Source = "data/en-zh_data/News-CommentaryV14/BPE/news14_train_en.BPE"
NMT_EDUs = "data/en-zh_data/News-CommentaryV14/BPE/news14_train_en_edus.BPE"
NMT_Doc = "data/en-zh_data/News-CommentaryV14/BPE/Docs/train.en"

NMT_Doc_EDUs = "data/en-zh_data/News-CommentaryV14/BPE/Docs/dev_edus.BPE"
NMT_Trees_p = "data/en-zh_data/News-CommentaryV14/BPE/Docs/dev_trees"
NMT_Trees = "data/en-zh_data/News-CommentaryV14/BPE/Docs/dev_trees.pkl"
NMT_Dep = "data/en-zh_data/News-CommentaryV14/BPE/Docs/dev_dep.pkl"


# End 2 End parsing
raw_dt = "data/e2e/raw.txt"
edu_dt = "data/e2e/edu.txt"
tree_dt = "data/e2e/tree.pkl"
dep_dt = "data/e2e/tree_dep.pkl"
