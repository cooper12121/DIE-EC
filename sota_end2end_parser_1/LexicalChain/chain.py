...
def readfile():
    infile_list = [
                  # "../RST_parse/data_process/ecb+/rst/dev_Event_gold_mentions_processed.json",
...
def write_file(filename,data):
    with open(f"../RST_parse/data_process/ecb+/final_processed/{filename}.json",'w',encoding='utf-8')as f:
